...
const AppointmentBooking = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const patientResponse = await emailjs.send(serviceId, templateId, emailData, publicKey);
      ...
      if (error.status === 400) {
        alert('Invalid email configuration. Please contact the clinic directly at +91 9014745988.');
      } else if (error.status === 401 || error.status === 403) {
        alert('Email service authentication failed. Please contact the clinic directly at +91 9014745988.');
      } else {
        alert('Unable to send confirmation email. Please call us at +91 9014745988 to confirm your appointment.');
      }
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-600 mb-6">
              Thank you for booking with Smile Care Dental. We've sent a confirmation email to{' '}
        ...
        >
          ...
          >
            <p className="text-sm text-gray-600 text-center">
              ...
              <a href="tel:+919014745988" className="text-teal-600 font-medium hover:underline">
                +91 9014745988
              </a>
